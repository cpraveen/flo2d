...
c----------------------------------------------------------------------
c     Set point type, whether point is interior or boundary
c----------------------------------------------------------------------
...
c     Set all boundary points to type "boundary"
      do i=1,nbe
         p1 = bdedge(1,i)
         p2 = bdedge(2,i)
...
c     Now set all solid points to type "solid"
      do i=1,nbe
         p1 = bdedge(1,i)
         p2 = bdedge(2,i)
...
c     Put all solid points into array spts
      nsp = 0
      do i=1,np
...
c     Count number of interior points: just for checking
      nip = 0
      do i=1,np
