...
!     Write pressure coefficient
      ...
      do i=nsw1,nsw2
         ...
         write(10,'(4e16.6)') coord(1,is), coord(2,is), cp, ent
      enddo
      close(10)

!     iso-pressure/mach/visc for gnuplot
...
!     Run gnuplot and Start xv if not already started
...
!------------------------------------------------------------------------------
      ...
      do i=1,np
         ...
         mach = sqrt(q2*prim(1,i)/(GAMMA*prim(4,i)))
         write(vig,*) mach
      enddo
      ...
      do i=1,np
         write(vig,*) log10(prim(4,i)/prim(1,i)**GAMMA/ent_inf )
      enddo
...
!------------------------------------------------------------------------------
!.....Result in VTK format for MayaVi/ParaView
!------------------------------------------------------------------------------
...
20    format(e18.8)
      ...
      write(maya,19)
      do i=1,np
         write(maya,20) log10(prim(4,i)/prim(1,i)**GAMMA/ent_inf)
      enddo
...
!------------------------------------------------------------------------------
!     Write some solution values: Used for optimization
!------------------------------------------------------------------------------
